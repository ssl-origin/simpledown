...
class main_controller
{
    ...
    /**
     * Registra uma ação no log de downloads (se ativado nas configurações)
     */
    protected function log_action(int $file_id, string $action): void
    {
        ...
        $sql_arr = [
            ...
            'username'    => $this->user->data['is_registered'] ? $this->user->data['username'] : $this->language->lang('GUEST'),
    ...
    /**
     * Página principal - Lista de downloads agrupada por categoria
     */
    ...
    public function preview(int $id): Response
    {
        ...
        $sql = 'SELECT is_private, file_realname, category_id, file_name
        ...
        if ($is_private && !$this->user->data['is_registered']) {
            $this->log_action($id, 'access_denied');
    ...
    public function download(int $id): Response
    {
        ...
        // Registra no log personalizado
        $this->log_action($id, 'download');

        // Log tradicional do phpBB (mantido para compatibilidade)

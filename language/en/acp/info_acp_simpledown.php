...
$lang = array_merge($lang, [
    ...
    'ACP_SIMPLEDOWN_SHORT_DESC_LIMIT_EXPLAIN'=> 'Maximum characters for the short description shown on cards (default: 150, recommended range: 100–200).',
    'ACP_SIMPLEDOWN_SITE_THEME'              => 'Site theme',
    'ACP_SIMPLEDOWN_SITE_THEME_EXPLAIN'      => 'Default visual theme displayed on the public Simple Downloads page for all visitors.',
    ...
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE_EXPLAIN' => 'If enabled, visitors can toggle between grid (cards) and list view. The choice is saved in a cookie.',
    ...
    'ACP_SIMPLEDOWN_PRIVATE_MESSAGE_EXPLAIN' => 'Text displayed when a non-logged-in visitor tries to access private content.',
    'ACP_SIMPLEDOWN_PRIVATE_MESSAGE_DEFAULT' => 'This file is exclusive to registered members. Log in or register to download.',
    ...
    'ACP_SIMPLEDOWN_FILE_NAME_EXPLAIN'       => 'Name displayed in administration and on the public downloads page.',
    'ACP_SIMPLEDOWN_DISPLAY_NAME'            => 'Public title (shown to users)',
    'ACP_SIMPLEDOWN_DISPLAY_NAME_EXPLAIN'    => 'Name that appears in the public downloads list. Does not affect the actual server file name.',
    ...
    'ACP_SIMPLEDOWN_UPLOAD_FILE_SUBMIT'      => 'Upload file', // Specific button
    ...
    'ACP_SIMPLEDOWN_REPLACE_FILE_HELP'       => 'The old file will be permanently deleted. The new one will be saved with a sanitized name (may be automatically renamed in case of conflict).',
    ...
    'ACP_SIMPLEDOWN_UPLOAD_THUMB_SUBMIT'      => 'Upload thumbnail', // Specific button
    'ACP_SIMPLEDOWN_UPLOAD_THUMB_EXPLAIN'    => 'Upload an image to use as thumbnail on the details page. Recommended: 300×300 px or larger (JPEG, PNG, WebP, GIF).',
    ...
    'ACP_SIMPLEDOWN_THUMB_PREVIEW_ALT'       => 'Thumbnail preview', // Added - used in img alt
    'CONFIRM_DELETE_THUMB'                   => 'WARNING: Do you want to PERMANENTLY delete this thumbnail? It cannot be recovered!',
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_MESSAGE_EXPLAIN' => 'Available placeholders:<br><strong>{NAME}</strong> – File name<br><strong>{VERSION}</strong> – Version<br><strong>{DESC_SHORT}</strong> – Short description<br><strong>{DESC_FORMATTED}</strong> – Full description with BBCode<br><strong>{URL_DETAILS}</strong> – Link to details page<br><strong>{URL_DOWNLOAD}</strong> – Direct download link<br><br><em>Full example provided by default.</em>',
    ...
    'LOG_SIMPLEDOWN_ANNOUNCE_DELETED'        => 'Deleted announcement topic for the file “%s”',
    ...
    'ACP_SIMPLEDOWN_ORPHAN_FILES_EXPLAIN'    => 'Physical files in the <code>/files/</code> folder that are not linked to any database record. They can be safely deleted.',
    ...
    'ACP_SIMPLEDOWN_TOOLS_LEGEND'            => 'Custom Tools tab content',
    'ACP_SIMPLEDOWN_TOOLS_LABEL'             => 'Custom text/HTML:',
    'ACP_SIMPLEDOWN_TOOLS_EXPLAIN'           => 'Write any content you want to display in the Tools tab here.<br>Supports basic HTML (links, images, lists, bold, etc.).',
    ...
    'CONFIRM_DELETE_ORPHAN'                  => 'WARNING: Do you want to PERMANENTLY delete this orphan file? It cannot be recovered!',
    ...
    'TOO_FEW_CHARS'                          => 'Your message has too few characters.',
    ...
    // ===================================================================
    // Compatibility keys with phpBB (used in tables/headers)
    // ===================================================================
    'SIZE'                                   => 'Size',
    'IP'                                     => 'IP',
    ...
    // ===================================================================
    'CONFIRM_DELETE_FILE'                    => 'Are you sure you want to delete this file?<br /><br /><strong>Warning:</strong> This action is irreversible and will also permanently delete the associated announcement topic and all its replies on the forum.',
]);
...
$lang = array_merge($lang, [
    ...
    'ACP_SIMPLEDOWN_SITE_THEME_EXPLAIN'         => 'Choose the default visual theme (Light or Dark) to be displayed on the public SimpleDown page for all visitors.',
    ...
    'ACP_SIMPLEDOWN_CARDS_PER_ROW_EXPLAIN'      => 'Defines how many download cards are displayed side-by-side on the main page.<br />• <strong>3 cards</strong>: Default layout (recommended for desktops).<br />• <strong>2 cards</strong>: Wider and more comfortable layout for medium screens.',
    'ACP_SIMPLEDOWN_CARDS'                      => 'cards per row',
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE'   => 'Allow users to choose layout',
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE_EXPLAIN' => 'When enabled, visitors can switch between grid (cards) and list views on the public downloads page. The choice is saved in a cookie.',
    ...
    'ACP_SIMPLEDOWN_DEFAULT_VISIBILITY_EXPLAIN' => 'This option sets the pre-selected value (Public or Private) when adding a new file.<br /><strong style="color: #c62828;">Individual file settings always take priority:</strong> if you mark a specific file as Public, it will be accessible to everyone (even if the default is Private), and vice-versa.',
    'ACP_SIMPLEDOWN_PRIVATE_CATEGORIES'         => 'Private categories',
    'ACP_SIMPLEDOWN_PRIVATE_CATEGORIES_EXPLAIN' => 'Select categories whose files will require login to download. Leave empty so that no file is private by category (individual control still works).',
    ...
    'ACP_SIMPLEDOWN_PRIVATE_MESSAGE'            => 'Private files message',
    'ACP_SIMPLEDOWN_PRIVATE_MESSAGE_EXPLAIN'    => 'This message is displayed when a guest tries to access a private file or a file from a private category.',
    ...
    'ACP_SIMPLEDOWN_DISPLAY_NAME_EXPLAIN'       => 'This is the name users will see in the download list. It does not affect the file name on the server.',
    ...
    'ACP_SIMPLEDOWN_DESCRIPTION_EXPLAIN'        => 'Full description displayed on the details page. BBCode supported.',
    ...
    'ACP_SIMPLEDOWN_REPLACE_FILE_HELP'          => 'The old file will be permanently deleted. The new one will be saved with a sanitized name (it may be renamed automatically if there is a conflict).',
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_LOCKED_EXPLAIN'    => 'If enabled, the announcement topic will be created locked (no replies allowed).',
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_MESSAGE_EXPLAIN'   => 'Available placeholders:<br><strong>{NAME}</strong> – File name<br><strong>{VERSION}</strong> – Version<br><strong>{DESC_SHORT}</strong> – Short description<br><strong>{DESC_FORMATTED}</strong> – Full description with BBCode<br><strong>{URL_DETAILS}</strong> – Link to details page<br><strong>{URL_DOWNLOAD}</strong> – Direct download link<br><br><em>Default example already filled.</em>',
    ...
    'ACP_SIMPLEDOWN_STATS_TOTAL_DOWNLOADS'      => 'Total downloads registered',
    ...
    'LOGS_DELETED_SUCCESS'                      => '%d logs successfully deleted.',
    'LOGS_CLEARED_OLD_SUCCESS'                  => 'Old logs have been successfully deleted.',
    'LOGS_CLEARED_ALL_SUCCESS'                  => 'All logs have been successfully deleted.',
    ...
    'ACP_SIMPLEDOWN_NO_THUMBS_FOUND'            => 'No thumbnails found in <code>/files/thumbs/</code>.',
    'ACP_SIMPLEDOWN_TOTAL_THUMBS'               => 'Total thumbnails',
    'ACP_SIMPLEDOWN_THUMB_DELETED'              => 'Thumbnail successfully deleted.',
    ...
    'ACP_SIMPLEDOWN_ORPHAN_DELETED'             => 'Orphan file successfully deleted.',
    ...
    'ACP_SIMPLEDOWN_TOOLS_EXPLAIN'              => 'Enter any content you wish to display on the Tools tab.<br />Supports basic HTML (links, images, lists, bold, etc.).',
    ...
    'ACP_SIMPLEDOWN_ALLOWED_FILES_TEXT_1'       => 'Permitted formats:',
    ...
    // ===================================================================
    'TOO_FEW_CHARS'                             => 'The provided value contains too few characters.',
    'TOO_MANY_CHARS'                            => 'The provided value contains too many characters.',

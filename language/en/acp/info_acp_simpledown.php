...
$lang = array_merge($lang, [
    ...
    'ACP_SIMPLEDOWN_SITE_THEME_EXPLAIN'     => 'Choose the default visual theme (light or dark) that will be displayed on the public SimpleDown page for all visitors.',
    ...
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE_EXPLAIN' => 'When enabled, visitors can toggle between grid (cards) and list view on the public downloads page. The choice is saved in a cookie.',
    ...
    'ACP_SIMPLEDOWN_DEFAULT_VISIBILITY_EXPLAIN' => 'This option sets the pre-selected value (public or private) when adding a new file.<br /><strong style="color: #c62828;">Individual file settings always take priority:</strong> if a specific file is marked as Public, it will be accessible to everyone (even if the default is Private), and vice-versa.',
    ...
    'ACP_SIMPLEDOWN_PRIVATE_MESSAGE_EXPLAIN'=> 'This message is displayed when an unauthenticated visitor tries to access a private file or a file in a private category.',
    ...
    'ACP_SIMPLEDOWN_CATEGORIES'             => 'Categories',
    ...
    'ACP_SIMPLEDOWN_DISPLAY_NAME_EXPLAIN'   => 'This is the name users will see in the download list. It does not affect the actual file name on the server.',
    ...
    'ACP_SIMPLEDOWN_REPLACE_FILE_WARNING'   => 'The old file will be permanently deleted when saving.',
    'ACP_SIMPLEDOWN_REPLACE_FILE_HELP'      => 'The old file will be permanently deleted. The new file will be saved with a sanitized name (may be automatically renamed if there is a conflict).',
    ...
    'ACP_SIMPLEDOWN_UPLOAD_THUMB_EXPLAIN'   => 'Upload an image to use as thumbnail on the details page. Recommended: 300×300px or larger.',
    ...
    'ACP_SIMPLEDOWN_ORPHAN_FILES_MANAGEMENT'=> 'Orphan Files Management',
    ...
    // ===================================================================
    // Default phpBB validation messages
    // ===================================================================
    'TOO_FEW_CHARS'                         => 'The value provided has too few characters.',
    'TOO_MANY_CHARS'                        => 'The value provided has too many characters.',

...
$lang = array_merge($lang, [
    ...
    'ACP_SIMPLEDOWN_SHORT_DESC_LIMIT_EXPLAIN'=> 'Maximum number of characters for the short description displayed on cards (default: 150).',
    ...
    'ACP_SIMPLEDOWN_PRIVATE_CATEGORIES_EXPLAIN' => 'Select categories where files will require login to download. Leave empty so that no category is private by default (individual control still works).',
    ...
    'ACP_SIMPLEDOWN_SELECT_CATEGORY_REQUIRED'=> 'Please select a category',
    ...
    'ACP_SIMPLEDOWN_REPLACE_FILE_HELP'       => 'The old file will be permanently deleted. The new one will be saved with a sanitized name (may be automatically renamed if there is a conflict).',
    ...
    'ACP_SIMPLEDOWN_STATS_TOTAL_DOWNLOADS'   => 'Total downloads recorded',

...
$lang = array_merge($lang, [
    ...
    'ACP_SIMPLEDOWN_PRIVATE_CATEGORIES_EXPLAIN' => 'Select categories whose files will require login to download. Leave empty so no file is private by category (individual control still works).',
    ...
    'ACP_SIMPLEDOWN_DEFAULT_VISIBILITY_EXPLAIN' => 'This option sets the pre-selected value (public or private) when adding a new file.<br /><strong style="color: #c62828;">Individual file settings always take maximum priority:</strong> if you mark a specific file as Public, it will be accessible to everyone (even if the default is Private), and vice versa.',
    'ACP_SIMPLEDOWN_CARDS_PER_ROW'          => 'Number of cards per row',
    'ACP_SIMPLEDOWN_CARDS_PER_ROW_EXPLAIN'  => 'Defines how many download cards are displayed side by side on the main downloads page.<br />• <strong>3 cards</strong>: default layout (recommended for desktops).<br />• <strong>2 cards</strong>: wider and more comfortable layout on medium screens.',
    'ACP_SIMPLEDOWN_CARDS'                  => 'cards per row',
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE' => 'Allow users to choose the layout',
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE_EXPLAIN' => 'When enabled, visitors can switch between grid view (cards) and list view on the public downloads page. The choice is saved in a cookie.',
    ...
    'ACP_SIMPLEDOWN_NO_CATEGORIES_EXIST'    => 'No categories created yet. Create at least one category before adding files.',
    ...
    'ACP_SIMPLEDOWN_DISPLAY_NAME_EXPLAIN'   => 'This is the name users will see in the downloads list. Does not affect the file name on the server.',
    ...
    'ACP_SIMPLEDOWN_DESCRIPTION_EXPLAIN'    => 'Full description displayed on the details page. Supports BBCode.',
    ...
    'ACP_SIMPLEDOWN_VISIBILITY_EXPLAIN'     => 'Define if the file is public (any visitor) or private (only logged-in users can download).',
    ...
    'ACP_SIMPLEDOWN_REPLACE_FILE_HELP'      => 'The old file will be permanently deleted. The new one will be saved with a sanitized name (may be automatically renamed if conflict).',
    ...
    'CONFIRM_CLEAR_ALL_LOGS'                => 'Are you sure you want to delete ALL logs? This action is irreversible!',
    'LOGS_DELETED_SUCCESS'                  => '%d logs deleted successfully.',
    'LOGS_CLEARED_OLD_SUCCESS'              => 'Old logs deleted successfully.',
    'LOGS_CLEARED_ALL_SUCCESS'              => 'All logs deleted successfully.',

    // ===================================================================
    // Tools Tab - Thumbnails
    // ===================================================================
    ...
    // ===================================================================
    // Tools Tab - Orphan Files
    // ===================================================================
    'ACP_SIMPLEDOWN_ORPHAN_FILES_MANAGEMENT'=> 'Orphan Files',
    'ACP_SIMPLEDOWN_ORPHAN_FILES_EXPLAIN'   => 'Physical files in the <code>/files/</code> folder not associated with any database record. Can be safely deleted.',
    ...
    'ACP_SIMPLEDOWN_ORPHAN_WARNING'         => 'Warning: these files are not used by any active download.',
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_EXPLAIN'       => 'When enabled, adding a new file will automatically create a topic in the forum configured for the category.',
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_PLACEHOLDERS'  => 'Available placeholders: {NAME} (file name), {VERSION} (version), {DESC_FORMATTED} (full description with BBCode), {URL_DETAILS} (link to details page)',
    'ACP_SIMPLEDOWN_ANNOUNCE_MAPPING'       => 'Category → Forum Mapping',
    'ACP_SIMPLEDOWN_ANNOUNCE_MAPPING_EXPLAIN' => 'Select the forum where the announcement topic will be created for each category. Leave blank to not create.',
    'ACP_SIMPLEDOWN_NO_CATEGORIES_MAPPING'  => 'No categories registered yet.',
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_MESSAGE_EXPLAIN' => 'Available placeholders:<br><strong>{NAME}</strong> – File name<br><strong>{VERSION}</strong> – Version<br><strong>{DESC_SHORT}</strong> – Short description (plain text)<br><strong>{DESC_FORMATTED}</strong> – Full description (with formatted BBCode)<br><strong>{URL_DETAILS}</strong> – Link to details page<br><strong>{URL_DOWNLOAD}</strong> – Direct download link<br><br><em>Full example already provided by default.</em>',
    ...
    // ===================================================================
    // Default phpBB validations (avoid warnings in message_parser)
    // ===================================================================
    'TOO_FEW_CHARS'                         => 'The provided value has too few characters.',
    'TOO_MANY_CHARS'                        => 'The provided value has too many characters.',
    'TOO_SMALL'                             => 'The provided value is too small.',
    'TOO_LARGE'                             => 'The provided value is too large.',

...
$lang = array_merge($lang, [
    ...
    'ACP_SIMPLEDOWN_LOGS' => 'Download Logs', // ← ADDED
    ...
    'ACP_SIMPLEDOWN_FILTER_BY_USERNAME' => 'Filter by user',
    'ACP_SIMPLEDOWN_FILTER_BY_ACTION' => 'Filter by action',
    'ACP_SIMPLEDOWN_FILTER_BY_DATE' => 'Filter by date',
    'ACP_SIMPLEDOWN_FROM' => 'From',
    'ACP_SIMPLEDOWN_TO' => 'To',
    'ACP_SIMPLEDOWN_CLEAR_FILTERS' => 'Clear filters',
    ...
    'ACP_SIMPLEDOWN_CARDS_PER_ROW_EXPLAIN' => 'Sets how many download cards are displayed side by side on the main downloads page.<br />• <strong>3 cards</strong>: default layout (recommended for desktops).<br />• <strong>2 cards</strong>: wider and more comfortable layout on medium screens.',
    'ACP_SIMPLEDOWN_CARDS' => 'cards per row',
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE' => 'Allow users to choose layout',
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE_EXPLAIN' => 'When enabled, visitors can toggle between grid (cards) and list view on the public downloads page. Choice is saved in a cookie.',
    ...
    'ACP_SIMPLEDOWN_DISPLAY_NAME_EXPLAIN' => 'This is the name users will see in the downloads list. It does not affect the actual filename on the server.',
    ...
    'ACP_SIMPLEDOWN_UPLOAD_THUMB_EXPLAIN' => 'Upload an image to use as thumbnail on the details page. Recommended: 300x300px or larger.',
    ...
    'ACP_SIMPLEDOWN_THUMB_UPLOAD_SUCCESS' => 'Thumbnail uploaded successfully!',
    'ACP_SIMPLEDOWN_ORPHANS_DELETED' => '%d orphan thumbnails have been deleted.',
    ...
    // ===================================================================
    // Keys for custom upload and search
    // ===================================================================
    ...
    // ===================================================================
    // Orphan Files Management (/files/ folder)
    // ===================================================================
    'ACP_SIMPLEDOWN_ORPHAN_FILES_MANAGEMENT' => 'Orphan Files Management',
    'ACP_SIMPLEDOWN_ORPHAN_FILES_EXPLAIN' => 'Lists physical files in the <code>ext/mundophpbb/simpledown/files/</code> folder that are not associated with any database record (orphan files).',
    ...
    'ACP_SIMPLEDOWN_NO_ORPHAN_FILES_FOUND' => 'No orphan files found in the <code>/files/</code> folder.',
    'ACP_SIMPLEDOWN_FILE_DELETED' => 'Orphan file deleted successfully.',
    'ACP_SIMPLEDOWN_FILE_DELETE_FAILED' => 'Failed to delete orphan file.',
    'ACP_SIMPLEDOWN_TOTAL_ORPHAN_FILES' => 'Total orphan files found',

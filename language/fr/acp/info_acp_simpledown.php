...
$lang = array_merge($lang, [
    ...
    'ACP_SIMPLEDOWN_PRIVATE_CATEGORIES_EXPLAIN'   => 'Sélectionnez les catégories dont les fichiers nécessiteront une connexion pour le téléchargement. Laissez vide pour qu\'aucun fichier ne soit privé par catégorie (le contrôle individuel continue de fonctionner).',
    ...
    'ACP_SIMPLEDOWN_DEFAULT_VISIBILITY_EXPLAIN'   => 'Cette option définit la valeur pré-sélectionnée (publique ou privée) lors de l\'ajout d\'un nouveau fichier.<br /><strong style="color: #c62828;">La configuration individuelle de chaque fichier a toujours la priorité maximale :</strong> si vous marquez un fichier spécifique comme Public, il sera accessible à tous (même si le défaut est Privé), et vice versa.',
    'ACP_SIMPLEDOWN_CARDS_PER_ROW'                => 'Nombre de cartes par ligne',
    'ACP_SIMPLEDOWN_CARDS_PER_ROW_EXPLAIN'        => 'Définit combien de cartes de téléchargement sont affichées côte à côte sur la page principale des téléchargements.<br />• <strong>3 cartes</strong> : disposition par défaut (recommandée pour ordinateurs).<br />• <strong>2 cartes</strong> : disposition plus large et confortable sur écrans moyens.',
    ...
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE_EXPLAIN' => 'Lorsque activé, les visiteurs peuvent basculer entre vue en grille (cartes) et vue en liste sur la page publique des téléchargements. Le choix est sauvegardé dans un cookie.',
    ...
    'ACP_SIMPLEDOWN_UPLOAD_THUMB_EXPLAIN'         => 'Uploadez une image à utiliser comme miniature sur la page de détails. Recommandé : 300x300px ou plus.',
    ...
    // ===================================================================
    // Outils (Miniatures, Fichiers Associés & Orphelins)
    // ===================================================================
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_EXPLAIN'          => 'Lorsque activé, l\'ajout d\'un nouveau fichier créera automatiquement un sujet dans le forum configuré pour la catégorie.',
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_PLACEHOLDERS'     => 'Placeholders disponibles : {NAME} (nom du fichier), {VERSION} (version), {DESC_FORMATTED} (description complète avec BBCode), {URL_DETAILS} (lien vers la page de détails)',
    'ACP_SIMPLEDOWN_ANNOUNCE_MAPPING'          => 'Mapping Catégorie → Forum',
    'ACP_SIMPLEDOWN_ANNOUNCE_MAPPING_EXPLAIN'  => 'Sélectionnez le forum où le sujet d\'annonce sera créé pour chaque catégorie. Laissez vide pour ne pas créer.',
    'ACP_SIMPLEDOWN_NO_CATEGORIES_MAPPING'     => 'Aucune catégorie enregistrée pour le moment.',
    'ACP_SIMPLEDOWN_ANNOUNCE_FORUM'            => 'Forum d\'annonce',
    'ACP_SIMPLEDOWN_NO_FORUM'                  => '-- Aucun forum sélectionné --',
    'ACP_SIMPLEDOWN_ANNOUNCE_TITLE_EXPLAIN'    => 'Placeholders disponibles :<br><strong>{NAME}</strong> – Nom du fichier<br><strong>{VERSION}</strong> – Version<br><br><em>Exemple recommandé : [Nouveau téléchargement] {NAME} v{VERSION}</em>',
    'ACP_SIMPLEDOWN_ANNOUNCE_MESSAGE_EXPLAIN'  => 'Placeholders disponibles :<br><strong>{NAME}</strong> – Nom du fichier<br><strong>{VERSION}</strong> – Version<br><strong>{DESC_SHORT}</strong> – Description courte (texte brut)<br><strong>{DESC_FORMATTED}</strong> – Description complète (avec BBCode formaté)<br><strong>{URL_DETAILS}</strong> – Lien vers la page de détails<br><strong>{URL_DOWNLOAD}</strong> – Lien direct de téléchargement<br><br><em>Exemple complet déjà fourni par défaut.</em>',
    ...
    // ===================================================================
    // Actions et Messages d'Interface
    // ===================================================================
    ...
    'ACP_SIMPLEDOWN_BBCODE_SIZE_TITLE'      => 'Taille de police',

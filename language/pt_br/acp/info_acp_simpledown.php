...
$lang = array_merge($lang, [
    ...
    // ===================================================================
    // Aba Ferramentas - Arquivos Associados
    // ===================================================================
    ...
    // ===================================================================
    // Aba Ferramentas - Arquivos Órfãos
    // ===================================================================
    ...
    // ===================================================================
    // Aba Ferramentas - Conteúdo Personalizado
    // ===================================================================
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_EXPLAIN'       => 'Quando ativado, ao adicionar um novo arquivo será criado automaticamente um tópico no fórum configurado para a categoria.',
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_PLACEHOLDERS'  => 'Placeholders disponíveis: {NAME} (nome do arquivo), {VERSION} (versão), {DESC_FORMATTED} (descrição completa com BBCode), {URL_DETAILS} (link para página de detalhes)',
    'ACP_SIMPLEDOWN_ANNOUNCE_MAPPING'       => 'Mapeamento Categoria → Fórum',
    'ACP_SIMPLEDOWN_ANNOUNCE_MAPPING_EXPLAIN' => 'Selecione o fórum onde o tópico anúncio será criado para cada categoria. Deixe em branco para não criar.',
    'ACP_SIMPLEDOWN_NO_CATEGORIES_MAPPING'  => 'Nenhuma categoria cadastrada ainda.',
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_MESSAGE_EXPLAIN' => 'Placeholders disponíveis:<br><strong>{NAME}</strong> – Nome do arquivo<br><strong>{VERSION}</strong> – Versão<br><strong>{DESC_SHORT}</strong> – Descrição curta (texto plano)<br><strong>{DESC_FORMATTED}</strong> – Descrição completa (com BBCode formatado)<br><strong>{URL_DETAILS}</strong> – Link para página de detalhes<br><strong>{URL_DOWNLOAD}</strong> – Link direto para download<br><br><em>Exemplo completo já preenchido por padrão.</em>',
    ...
    // ===================================================================
    // Validações padrão do phpBB (evitam warnings no message_parser)
    // ===================================================================

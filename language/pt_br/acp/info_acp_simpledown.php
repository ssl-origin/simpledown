...
$lang = array_merge($lang, [
    ...
    'ACP_SIMPLEDOWN_MAX_UPLOAD_SIZE_EXPLAIN' => 'Limite em MB para arquivos enviados (padrão: 100 MB). Mínimo permitido: 1 MB.',
    'ACP_SIMPLEDOWN_UPLOAD_SIZE'        => 'MB',
    'ACP_SIMPLEDOWN_SHORT_DESC_LIMIT'   => 'Limite de caracteres da descrição curta',
    'ACP_SIMPLEDOWN_SHORT_DESC_LIMIT_EXPLAIN' => 'Máximo de caracteres para a descrição curta exibida nos cards (padrão: 150, intervalo recomendado: 100–200).',
    'ACP_SIMPLEDOWN_SITE_THEME'         => 'Tema do site',
    'ACP_SIMPLEDOWN_SITE_THEME_EXPLAIN' => 'Tema visual padrão exibido na página pública do Simple Downloads para todos os visitantes.',
    ...
    'ACP_SIMPLEDOWN_CARDS_PER_ROW_EXPLAIN' => 'Quantos cards de download são exibidos lado a lado na página principal.<br>• <strong>3 cards</strong>: layout padrão (recomendado para desktops)<br>• <strong>2 cards</strong>: mais confortável em telas médias',
    'ACP_SIMPLEDOWN_CARDS'              => 'cards por linha',
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE' => 'Permitir que visitantes escolham o layout',
    'ACP_SIMPLEDOWN_ALLOW_USER_LAYOUT_CHOICE_EXPLAIN' => 'Se ativado, os visitantes poderão alternar entre visualização em grade (cards) e lista. A escolha é salva em cookie.',
    ...
    'ACP_SIMPLEDOWN_DEFAULT_VISIBILITY_EXPLAIN' => 'Define o valor pré-selecionado ao adicionar novo arquivo.<br><strong style="color:#c62828">A configuração individual de cada arquivo sempre tem prioridade.</strong>',
    'ACP_SIMPLEDOWN_PRIVATE_CATEGORIES' => 'Categorias privadas',
    'ACP_SIMPLEDOWN_PRIVATE_CATEGORIES_EXPLAIN' => 'Arquivos nestas categorias exigirão login para download. Deixe vazio para desativar regra por categoria.',
    'ACP_SIMPLEDOWN_PRIVATE_CATEGORIES_HOLD_CTRL' => 'Segure Ctrl (ou Cmd no Mac) para selecionar múltiplas categorias.',
    'ACP_SIMPLEDOWN_PRIVATE_MESSAGE'    => 'Mensagem para arquivos/categorias privadas',
    'ACP_SIMPLEDOWN_PRIVATE_MESSAGE_EXPLAIN' => 'Texto exibido quando visitante não logado tenta acessar conteúdo privado.',
    ...
    'ACP_SIMPLEDOWN_NO_CATEGORIES_YET'  => 'Nenhuma categoria criada ainda.',
    ...
    'ACP_SIMPLEDOWN_SELECT_CATEGORY_REQUIRED' => 'Selecione uma categoria válida.',
    ...
    'ACP_SIMPLEDOWN_NO_CATEGORIES_EXIST' => 'Nenhuma categoria foi criada ainda. Crie pelo menos uma antes de adicionar arquivos.',

    // ===================================================================
    // Gestão de Arquivos (Adicionar/Editar)
    // ===================================================================
    'ACP_SIMPLEDOWN_FILE_NAME'          => 'Nome do arquivo (interno)',
    'ACP_SIMPLEDOWN_FILE_NAME_EXPLAIN'  => 'Nome exibido na administração e na página pública de downloads.',
    'ACP_SIMPLEDOWN_DISPLAY_NAME'       => 'Título público (exibido aos usuários)',
    'ACP_SIMPLEDOWN_DISPLAY_NAME_EXPLAIN' => 'Nome que aparece na lista pública de downloads. Não afeta o nome real no servidor.',
    ...
    'ACP_SIMPLEDOWN_DESCRIPTION_EXPLAIN' => 'Texto detalhado na página do arquivo. Suporta BBCode.',
    'ACP_SIMPLEDOWN_EDIT_DESCRIPTION'   => 'Editar Descrição',
    'ACP_SIMPLEDOWN_VERSION'            => 'Versão',
    'ACP_SIMPLEDOWN_VERSION_EXPLAIN'    => 'Opcional. Exemplos: 1.0, 2.1-beta, Final 2025',
    'ACP_SIMPLEDOWN_VISIBILITY'         => 'Visibilidade do arquivo',
    'ACP_SIMPLEDOWN_VISIBILITY_EXPLAIN' => 'Público = qualquer visitante pode baixar<br>Privado = apenas usuários logados podem baixar.',
    'ACP_SIMPLEDOWN_PUBLIC'             => 'Público',
    'ACP_SIMPLEDOWN_PRIVATE'            => 'Privado',
    'ACP_SIMPLEDOWN_UPLOAD_FILE'        => 'Enviar Arquivo',
    'ACP_SIMPLEDOWN_UPLOAD_FILE_SUBMIT' => 'Enviar arquivo',                    // Botão específico
    'ACP_SIMPLEDOWN_REPLACE_FILE'       => 'Substituir arquivo',
    'ACP_SIMPLEDOWN_REPLACE_FILE_EXPLAIN' => 'Marque para enviar uma nova versão. O arquivo antigo será excluído permanentemente.',
    'ACP_SIMPLEDOWN_REPLACE_FILE_WARNING' => 'O arquivo antigo será excluído permanentemente ao salvar.',
    'ACP_SIMPLEDOWN_REPLACE_FILE_HELP'  => 'O arquivo antigo será excluído permanentemente. O novo será salvo com nome sanitizado (pode ser renomeado automaticamente em caso de conflito).',
    ...
    'ACP_SIMPLEDOWN_NO_FILES_YET'       => 'Nenhum arquivo cadastrado ainda.',
    ...
    'ACP_SIMPLEDOWN_UPLOAD_THUMB_SUBMIT'=> 'Enviar miniatura',                  // Botão específico
    'ACP_SIMPLEDOWN_UPLOAD_THUMB_EXPLAIN' => 'Envie uma imagem para ser usada como miniatura na página de detalhes. Recomendado: 300×300 px ou maior (JPEG, PNG, WebP, GIF).',
    ...
    'ACP_SIMPLEDOWN_NO_THUMB'           => 'Sem miniatura',
    ...
    'ACP_SIMPLEDOWN_THUMB_PREVIEW_ALT'  => 'Pré-visualização da miniatura',     // Adicionada - usada em alt de img
    'CONFIRM_DELETE_THUMB' => 'ATENÇÃO: Deseja excluir esta miniatura PERMANENTEMENTE? Não será possível recuperar depois!',
    ...
    'ACP_SIMPLEDOWN_FORUM_ANNOUNCE_EXPLAIN' => 'Escolha o fórum no qual um tópico será criado para anunciar o novo arquivo disponível para download.',
    ...
    // ===================================================================
    // Logs de ações administrativas (ACP logs)
    // ===================================================================
    ...
    'LOG_SIMPLEDOWN_FILE_DOWNLOADED'    => '<strong>%1$s</strong> baixou o arquivo “%2$s”',
    ...
    // ===================================================================
    // Confirmações JavaScript (Ferramentas)
    // ===================================================================
    'ACP_SIMPLEDOWN_DELETE_THUMB_CONFIRM'       => 'Tem certeza que deseja excluir permanentemente esta miniatura?',
    'ACP_SIMPLEDOWN_DELETE_ORPHAN_CONFIRM'      => 'Tem certeza que deseja excluir permanentemente este arquivo órfão? Esta ação não pode ser desfeita!',
    'CONFIRM_DELETE_ORPHAN'                     => 'ATENÇÃO: Deseja excluir PERMANENTEMENTE este arquivo órfão? Não será possível recuperar depois!',
    ...
    // ===================================================================
    // Chaves de compatibilidade com phpBB (usadas em tabelas / cabeçalhos)
    // ===================================================================
    'SIZE'                              => 'Tamanho',
    'IP'                                => 'IP',

    // ===================================================================
    // Confirmação de exclusão de arquivo com anúncio associado
    // ===================================================================

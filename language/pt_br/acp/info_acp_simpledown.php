...
$lang = array_merge($lang, [
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_PLACEHOLDERS'     => 'Placeholders disponíveis: {NAME}, {VERSION}, {DESC_FORMATTED}, {URL_DETAILS}',
    ...
    'ACP_SIMPLEDOWN_ANNOUNCE_TITLE_EXPLAIN'    => 'Placeholders disponíveis:<br><strong>{NAME}</strong> – Nome<br><strong>{VERSION}</strong> – Versão',
    'ACP_SIMPLEDOWN_ANNOUNCE_MESSAGE_EXPLAIN'  => 'Placeholders: <strong>{NAME}</strong>, <strong>{VERSION}</strong>, <strong>{DESC_SHORT}</strong>, <strong>{DESC_FORMATTED}</strong>, <strong>{URL_DETAILS}</strong>, <strong>{URL_DOWNLOAD}</strong>.',
